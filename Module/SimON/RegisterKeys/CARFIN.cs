...
//    public class CARFIN : Key, IRootNode
//    {
...
//        {
//            // HTodo  ：加密名称 
//            this.carName = this.Name.Trim().Split(' ')[1].Trim();
...
//                newRegion.XFrom = strs[1].ToInt();
//                newRegion.XTo = strs[2].ToInt();
//                newRegion.YFrom = strs[3].ToInt();
//                newRegion.YTo = strs[4].ToInt();
//                newRegion.ZFrom = strs[5].ToInt();
//                newRegion.ZTo = strs[6].ToInt();
...
//                //if (tempStr.FormatKey() == this.Name.FormatKey())
//                //{
...
//            cs.Add(typeof(NXFIN).Name);
//            cs.Add(typeof(NYFIN).Name);
//            cs.Add(typeof(NZFIN).Name);
//            cs.Add(typeof(FINBOX).Name);
